...
const IL_ILCE = {
  ...
  'ankara':         ['altındağ','çankaya','etimesgut','keçiören','mamak','sincan','yenimahalle','pursaklar','gölbaşı','polatlı','beypazarı','nallıhan','güdül','kızılcahamam','çamlıdere','ayaş','bala','çubuk','elmadağ','evren','haymana','kahramankazan','kalecik','şereflikoçhisar','temelli'],
